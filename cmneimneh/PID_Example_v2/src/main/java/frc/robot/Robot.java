...
public class Robot extends TimedRobot {
    ...
    public void teleopPeriodic() {
        ...
        // Create motion profile based on the constraints and current state
        ...
        // Update motor controller with PID
        ...
        SmartDashboard.putNumber("Error", m_motor.getError(goal,m_motor.getEncoderDistance()));
