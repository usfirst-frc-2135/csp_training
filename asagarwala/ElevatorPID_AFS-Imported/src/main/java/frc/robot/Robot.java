...
public class Robot extends TimedRobot
{
  ...
  private final static double               kGoalTolerance   = 0.01; // Tolerance around the target goal allowed to consider move is
                                                    // finished (positive OR negative)
  ...
  {
    DataLogManager.start( ); // TODO: This enables logging for the entire robot, just needed when robot
                            // starts
  ...
  public void teleopPeriodic( )
  {
    ...
    if (m_controller.getStartButtonPressed( ))
    {
      ...
      m_pidEnabled = false;
      //
      // TODO: The above line does all of this - have a look at how it does this and
      // then delete
    ...
    // for all of the buttons above, either enable the pid (X and Y) or disable the
    // pid (A, B, Right Bumper, Start)
